                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: "Name",
                      labelStyle: TextStyle(fontWeight: FontWeight.bold, color: ColorResources.COLOR_PRIMARY,fontSize: 16),
                      ...
                      suffixIcon: Icon(Icons.person, color: ColorResources.COLOR_PRIMARY,),
                    ),
                  ),
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon: Icon(Icons.call, color: ColorResources.COLOR_PRIMARY,),
                    ),
                  ),
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      suffixIcon: Icon(Icons.email, color: ColorResources.COLOR_PRIMARY,),
                    ),
                  ),
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text(birthdate, style: TextStyle(fontWeight: FontWeight.bold, color: ColorResources.COLOR_PRIMARY,fontSize: 16),),
                          ),
                        ],
                      ),
                    ),
                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: DropdownButton(
                        hint: Text("Select Gender", style: TextStyle(color: ColorResources.COLOR_PRIMARY, fontWeight: FontWeight.bold),),
                        icon: Icon(Icons.arrow_drop_down, color: ColorResources.COLOR_PRIMARY,),
                        iconSize: 30,
                        isExpanded: true,
                        underline: SizedBox(),
                        style: TextStyle(
                  ...
                  Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.only(left: 15, right: 15),
                      child: DropdownButton(
                        hint: Text("Select Blood Group", style: TextStyle(color: ColorResources.COLOR_PRIMARY, fontWeight: FontWeight.bold),),
                        icon: Icon(Icons.arrow_drop_down, color: ColorResources.COLOR_PRIMARY,),
                        iconSize: 30,
                        isExpanded: true,
                        underline: SizedBox(),
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            padding: const EdgeInsets.only(left: 10),
                            child: Text(lastdate, style: TextStyle(fontWeight: FontWeight.bold, color: ColorResources.COLOR_PRIMARY,fontSize: 16),),
                          ),
                        ],
                      ),
                    ),
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        Text("Permanent Address ", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: ColorResources.COLOR_PRIMARY),),
                      ],
                    ),
                  ),
                  ...
                  Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.only(left: 15, right: 15),
                      child: DropdownButton(
                        hint: Text("Division", style: TextStyle(color: ColorResources.COLOR_PRIMARY, fontWeight: FontWeight.bold),),
                        icon: Icon(Icons.arrow_drop_down, color: ColorResources.COLOR_PRIMARY,),
                        iconSize: 30,
                        isExpanded: true,
                        underline: SizedBox(),
                  ...
                  Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.only(left: 15, right: 15),
                      child: DropdownButton(
                        hint: Text("District", style: TextStyle(color: ColorResources.COLOR_PRIMARY, fontWeight: FontWeight.bold),),
                        icon: Icon(Icons.arrow_drop_down, color: ColorResources.COLOR_PRIMARY,),
                        iconSize: 30,
                        isExpanded: true,
                        underline: SizedBox(),
                  ...
                  Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.only(left: 15, right: 15),
                      child: DropdownButton(
                        hint: Text("Upazilas", style: TextStyle(color: ColorResources.COLOR_PRIMARY, fontWeight: FontWeight.bold),),
                        icon: Icon(Icons.arrow_drop_down, color: ColorResources.COLOR_PRIMARY,),
                        iconSize: 30,
                        isExpanded: true,
                        underline: SizedBox(),
                  ...
                  Container(
                    ...
                    child: Padding(
                      padding: const EdgeInsets.only(left: 15, right: 15),
                      child: DropdownButton(
                        hint: Text("Union", style: TextStyle(color: ColorResources.COLOR_PRIMARY, fontWeight: FontWeight.bold),),
                        icon: Icon(Icons.arrow_drop_down, color: ColorResources.COLOR_PRIMARY,),
                        iconSize: 30,
                        isExpanded: true,
                        underline: SizedBox(),
                  ...
                  Row(
                    ...
                    children: [
                      TextButton(
                          ...
                          child: Text("Skip >", style: TextStyle(fontWeight: FontWeight.bold, color: ColorResources.COLOR_PRIMARY),)),
                    ],
                  ),
                  SizedBox(height: 20,),
                ],
